...
public class EnemiesShieldAndDestruction : MonoBehaviour
{
...
//    [SerializeField] private bool _isEnemyEquippedWithShieldsSurround = false;
    ...
    */
    ...
    {
        if (_enemyCore.isEnemyEquippedWithShieldsFrontal == true || _enemyCore.isEnemyEquippedWithShieldsSurround == true)
        {
            _shieldHits++;
            ...
            switch (_shieldHits)
            {
                case 1:
                    ...
                    _enemyCore.enemyShield.GetComponent<SpriteRenderer>().material.color = new Color(1f, 1f, 1f, _enemyShieldAlpha);
                    break;
                case 2:
        ...
        DestroyEnemyShip(_enemyCore.pointsWorth);  
    }
